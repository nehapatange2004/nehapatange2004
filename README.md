...
## 👋 Hey there, I'm Neha Patange

---

## About me
I build things for the web — fast, scalable, and built with intention.  
I enjoy creating real-world, full-stack products that actually *ship*, whether it's real-time chat systems, AI-powered tools, or clean frontend experiences backed by solid APIs.

I learn quickly, break things deliberately, fix them properly, and keep moving.  
If you're here to explore what I build — welcome.
...
Short & scannable — repo links to explore.

- **Yaps & Chats — Real-Time Chat**  
  - Live: https://yaps-chats.netlify.app/  
  - Highlights: JWT auth • bcrypt • Socket.IO • multi-theme UI  
  - Repo: `https://github.com/nehapatange2004/Yaps-Chats`

- **AI Frontend Builder — Prompt → UI**  
  - Highlights: Gemini-powered UI generation • Sandpack preview • session-driven prompts  
   <!--- Repo: `https://github.com/nehapatange2004/WITH_UI_BUILDER_REPO` -->
...
<p>
 • &nbsp
  <a href="mailto:nehapatange2004@gmail.com" title="Email">
    <svg width="16" height="16" viewBox="0 0 24 24" style="vertical-align:middle; margin-right:6px;"><title>Email</title><rect x="2" y="5" width="20" height="14" rx="2" fill="#0EA5E9"/><polyline points="3,7 12,13 21,7" fill="none" stroke="#fff" stroke-width="1.5"/></svg>
    nehapatange2004@gmail.com
  </a>
  &nbsp; • &nbsp;
  <a href="https://github.com/nehapatange2004" title="GitHub">
    <svg width="16" height="16" viewBox="0 0 24 24" style="vertical-align:middle; margin-right:6px;"><title>GitHub</title><path fill="#111" d="M12 .296a12 12 0 00-3.8 23.4c.6.1.8-.2.8-.5v-1.8c-3.3.7-4-1.6-4-1.6-.5-1.2-1.2-1.5-1.2-1.5-1-.7.1-.7.1-.7 1.1.1 1.7 1.1 1.7 1.1 1 .1 1.6.7 2 1.1.1-.8.4-1.4.7-1.7-2.6-.3-5.4-1.3-5.4-6 0-1.3.4-2.4 1.1-3.2-.1-.3-.5-1.6.1-3.3 0 0 .9-.3 3 1.1a10.3 10.3 0 015.5 0c2.1-1.4 3-1.1 3-1.1.6 1.7.2 3 .1 3.3.7.8 1.1 1.9 1.1 3.2 0 4.7-2.8 5.6-5.4 5.9.4.4.7 1 .7 2v3c0 .3.2.6.8.5A12 12 0 0012 .296z"/></svg>
    github.com/nehapatange2004
  </a>
  &nbsp; • &nbsp;
  <a href="https://linkedin.com/in/neha-patange-a8844b271" title="LinkedIn">
    <svg width="16" height="16" viewBox="0 0 24 24" style="vertical-align:middle; margin-right:6px;"><title>LinkedIn</title><rect x="2" y="2" width="20" height="20" rx="2" fill="#0A66C2"/><path d="M6 9H4v9h2zM5 6.9a1.1 1.1 0 110-2.2 1.1 1.1 0 010 2.2zM12 12.8v3.1h2v-2.8c0-1.6 1.1-2.4 2.4-2.4 1.3 0 1.9.9 1.9 2.4v3h2v-3.2c0-3.3-1.8-4.8-4.6-4.8-2.1 0-3.1 1.1-3.6 1.9h-.1v-1.6h-2z" fill="#fff"/></svg>
    linkedin.com/in/neha-patange-a8844b271
  </a>
</p>

---

<div align="center" style="margin-top:18px; padding:10px;">
  <strong>⭐ If you like my work, please leave a star on the repos you find useful.</strong>
</div>
